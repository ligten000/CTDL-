...
void inDanhSachLop(DanhSachLop &dsLop, int start, int end){
            ...
            if(demSinhVien(dsLop.lop[i]->listSV) != 0){
                ...
                while(true){
                    ...
                    if(confirm == 'Y'){
                        ...
                        clearLine(0,mouse + 1,100);
                        break;
                    }
                    if(confirm == 'N'){
                        thongBaoLoi("Huy thao tac!", 0,mouse +2);
                        return;
                    }
                }
            }
